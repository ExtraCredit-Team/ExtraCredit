            ...
            <div style={{border: "1px solid #cccccc", padding: 16, width: 400, margin: "auto", marginTop: 64}}>
                ...
                <div style={{margin: 8}}>
                    ...
                    <Button onClick={() => {
                        ...
                        tx(writeContracts.CreditPool.setDeposit(newPurpose))
                    }}>Set Deposit</Button>
                </div>
                ...
                <div style={{margin: 8}}>
                    <Button onClick={() => {
                        /* look how you call setPurpose on your contract: */
                        tx(writeContracts.CreditPool.setPurpose("🍻 Cheers"))
                ...
                <div style={{margin: 8}}>
                    <Button onClick={() => {
                        ...
                        tx(writeContracts.CreditPool.setPurpose("💵 Paying for this one!", {
                            value: parseEther("0.001")
                        }))
