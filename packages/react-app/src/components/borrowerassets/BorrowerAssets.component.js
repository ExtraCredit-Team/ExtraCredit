...
export function BorrowerAssets({ onShow }) {
  return (
    <Row className="mt-5">
        ...
        <Card className="shadow">
          <CardHeader className="border-0">
            <Row className="align-items-center">
              <div className="col">
                <h3 className="mb-0">Deposit to assets</h3>
              </div>
          ...
          <Table className="align-items-center table-flush" responsive>
            ...
            <tbody>
              <tr>
                ...
                <td>2.8%</td>
                <td>
                  <i className="fas fa-arrow-up text-success mr-3" /> 10$
                </td>
                <td>0.000021</td>
                <td>$6</td>
                <td>
                  <BorrowButton onShow={onShow} />
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>10.1%</td>
                <td>
                  <i className="fas fa-equals text-warning mr-3" /> 0$
                </td>
                <td>0</td>
                <td>$0</td>
                <td>
