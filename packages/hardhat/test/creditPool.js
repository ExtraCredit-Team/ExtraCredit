...
describe("Credit Delegation flow", function() {
	...
	it("should deposit", async function () {
		...
		await dai.approve(lendingPoolAddress, ethers.utils.parseEther('1000'));
		// deposit to aave and get adai
		await lendingPool.deposit(daiAddress, ethers.utils.parseEther('100'), whalePax, 0);
		...
		await creditPool.deposit(ethers.utils.parseEther('1'), adai.address, marginPool.address, ethers.utils.parseEther('20000'), dai.address);
	});
