...
const main = async () => {
  ...
  // const yourContract2 = await deploy("CreditPool"); // <-- add in constructor args like line 16 vvvv
  // const creditPoolContract = await deploy("CreditPool"); // <-- add in constructor args like line 16 vvvv
